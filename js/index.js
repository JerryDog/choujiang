...
var luckyMan = [];
var timer;//定时器
var times = 0;//抽奖次数,如果不是第一次，不加粗显示领导姓名
// step 每一轮奖品
var steps = ["第一轮 《抱枕》 2名", "第二轮 《毯子》 5名", "第三轮 《杯子》 5名",
    "第四轮 《充电宝》 3名", "第五轮 《加湿器》 2名", "第六轮 《榨汁机》 2名",
    "第七轮 《蚕丝被》 1名", "第八轮 《电压力锅》 1名"];
$(function () {
    iconAnimation();
    //开始抽奖
    ...
    $("#btnReset").on("click", function () {
        ...
        showConfirm("确认开始下一轮抽奖吗？", function () {
            //熏置未中奖人员名单
...
function startLuckDraw() {
    ...
    var tempHtml = "";
    if(times===3 && leaderArr.indexOf('应贝贝') > -1){
        randomPerson = ['应贝贝'];
        leaderArr = leaderArr.delete('应贝贝');
    }
